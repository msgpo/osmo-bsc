...
{
	bool result_requires_voice_alt = false;
	bool result_requires_voice_pref = false;
	...
	case GSM48_CMODE_SPEECH_EFR:
	case GSM48_CMODE_SPEECH_AMR:
		result_requires_voice_pref = true;
		break;
	case GSM48_CMODE_SIGN:
		result_requires_voice_pref = false;
		break;
	default:
	...
	case GSM48_CMODE_SPEECH_EFR:
	case GSM48_CMODE_SPEECH_AMR:
		result_requires_voice_alt = true;
		break;
	case GSM48_CMODE_SIGN:
		result_requires_voice_alt = false;
		break;
	default:
		assignment_fail(GSM0808_CAUSE_REQ_CODEC_TYPE_OR_CONFIG_NOT_SUPP,
