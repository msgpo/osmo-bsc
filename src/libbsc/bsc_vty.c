...
DEFUN(handover_any, handover_any_cmd,
      "handover any",
      MANUAL_HANDOVER_STR
      "Pick any actively used lchan and handover to any other BTS."
      " This is only useful if all BTS are guaranteed to be reachable by the MS\n")
{
...
DEFUN(assignment_any, assignment_any_cmd,
      "assignment any",
      MANUAL_ASSIGNMENT_STR
      "Pick any actively used lchan and re-assign within the same BTS.\n")
{
	struct gsm_lchan *from_lchan;
