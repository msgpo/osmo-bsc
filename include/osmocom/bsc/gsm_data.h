...
static const struct rate_ctr_desc bsc_ctr_description[] = {
	[BSC_CTR_ASSIGNMENT_ATTEMPTED] =	{"assignment:attempted", "Re-assignment attempts."},
	[BSC_CTR_ASSIGNMENT_COMPLETED] =	{"assignment:completed", "Re-assigment completed."},
	[BSC_CTR_ASSIGNMENT_STOPPED] = 		{"assignment:stopped", "Connection ended."},
	[BSC_CTR_ASSIGNMENT_NO_CHANNEL] = 	{"assignment:no_channel", "Failure to allocate lchan."},
	...
	[BSC_CTR_HANDOVER_ATTEMPTED] =		{"handover:attempted", "Re-assignment attempts."},
	[BSC_CTR_HANDOVER_COMPLETED] =		{"handover:completed", "Re-assigment completed."},
	[BSC_CTR_HANDOVER_STOPPED] = 		{"handover:stopped", "Connection ended."},
	[BSC_CTR_HANDOVER_NO_CHANNEL] = 	{"handover:no_channel", "Failure to allocate lchan."},
	[BSC_CTR_HANDOVER_TIMEOUT] = 		{"handover:timeout", "Re-assignment timed out."},
	[BSC_CTR_HANDOVER_FAILED] = 		{"handover:failed", "Received FAIL message."},
	[BSC_CTR_HANDOVER_ERROR] = 		{"handover:error", "Re-assigment failed for other reason."},

	[BSC_CTR_INTER_BSC_HO_MO_ATTEMPTED] =	{"interbsc_ho_mo:attempted", "Re-assignment attempts."},
	[BSC_CTR_INTER_BSC_HO_MO_COMPLETED] =	{"interbsc_ho_mo:completed", "Re-assigment completed."},
	[BSC_CTR_INTER_BSC_HO_MO_STOPPED] = 	{"interbsc_ho_mo:stopped", "Connection ended."},
	[BSC_CTR_INTER_BSC_HO_MO_TIMEOUT] = 	{"interbsc_ho_mo:timeout", "Re-assignment timed out."},
	[BSC_CTR_INTER_BSC_HO_MO_ERROR] = 	{"interbsc_ho_mo:error", "Re-assigment failed for other reason."},

	[BSC_CTR_INTER_BSC_HO_MT_ATTEMPTED] =	{"interbsc_ho_mt:attempted", "Re-assignment attempts."},
	[BSC_CTR_INTER_BSC_HO_MT_COMPLETED] =	{"interbsc_ho_mt:completed", "Re-assigment completed."},
	[BSC_CTR_INTER_BSC_HO_MT_STOPPED] = 	{"interbsc_ho_mt:stopped", "Connection ended."},
	[BSC_CTR_INTER_BSC_HO_MT_NO_CHANNEL] = 	{"interbsc_ho_mt:no_channel", "Failure to allocate lchan."},
	[BSC_CTR_INTER_BSC_HO_MT_TIMEOUT] = 	{"interbsc_ho_mt:timeout", "Re-assignment timed out."},
	[BSC_CTR_INTER_BSC_HO_MT_FAILED] = 	{"interbsc_ho_mt:failed", "Received FAIL message."},
	[BSC_CTR_INTER_BSC_HO_MT_ERROR] = 	{"interbsc_ho_mt:error", "Re-assigment failed for other reason."},
